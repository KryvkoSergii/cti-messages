 ...
 */
public class MonitorStartConf extends Header {
    ...
    //Constructors
    public MonitorStartConf() {
    }


    //Static Methods
    public static MonitorStartConf deserializeMessage(byte[] bytes) throws UnsupportedEncodingException {
        ByteBuffer buffer = ByteBuffer.wrap(bytes);
        MonitorStartConf message = new MonitorStartConf();
        try {
    ...
    public byte[] serializeMessage() throws Exception {
        try {
            ...
            throw new Exception("Buffer overflowed during Monitor_Start_Conf serialization!");
        }
    }
